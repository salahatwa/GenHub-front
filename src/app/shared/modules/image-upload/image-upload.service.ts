...
import { AttachmentControllerService } from "../../services/attachmentControlle.service";

@Injectable({
  providedIn: "root",
})
export class ImageUploadService {
  constructor(private http: HttpClient,private attachmenetService:AttachmentControllerService) {
  ...
  uploadImage(image: ImageSnippet): Observable<any> {
   ...
   return this.attachmenetService.uploadAttachment(file);
